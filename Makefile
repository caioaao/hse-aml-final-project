...
.data/processed/%-features-022.parquet: src/feature_engineering/make_feature_set_022.py .data/processed/%.parquet .data/processed/release-dates.parquet | .data/processed
	pipenv run scripts/runpy.sh $^ $@
